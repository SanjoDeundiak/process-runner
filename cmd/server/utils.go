...
func toProtoProcessState(s lib.ProcessState) protov1.ProcessState {
	...
	case lib.ProcessStateSleeping:
		return protov1.ProcessState_PROCESS_STATE_SLEEPING
	case lib.ProcessStateStopped:
		return protov1.ProcessState_PROCESS_STATE_STOPPED
	case lib.ProcessStateZombie:
		return protov1.ProcessState_PROCESS_STATE_ZOMBIE
	default:
