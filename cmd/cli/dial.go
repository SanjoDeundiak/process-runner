...
// dial is used by commands to establish a gRPC connection. It defaults to dialFromEnv
// and is overridden in tests.
var dial = dialFromEnv

func dialFromEnv(ctx context.Context) (*grpc.ClientConn, error) {
	...
	// Use WithBlock to surface TLS auth errors quickly
